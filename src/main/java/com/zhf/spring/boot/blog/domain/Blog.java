...
public class Blog implements Serializable {
    ...
    public List<Comment> getComments() {
        sort(comments, new Comparator<Comment>() {
            @Override
            public int compare(Comment comment1, Comment comment2) {
                if(comment1.getCreateTime().before(comment2.getCreateTime())){
                    return 1;
                }else if(comment1.getCreateTime().after(comment2.getCreateTime())){
                   return -1;
                }
                return 0;
            }
